...
serviceRouter.post("/Add_Service", Add_Service as unknown as RequestHandler);
serviceRouter.delete("/delete_service/:service_id", delete_service as unknown as RequestHandler);
serviceRouter.put("/update_service", update_service as unknown as RequestHandler);
serviceRouter.get("/get_all_services", get_all_serivces as unknown as RequestHandler);
serviceRouter.delete("/delete_all_services", delete_all_services as unknown as RequestHandler);
